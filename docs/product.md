...
| `DUNGEON1` | Buzzing Plains | Level 3 | Easy | `Workspace.Destinations.DUNGEON1` |
| `DUNGEON10` | Blackthorn Mountain | Level 10 | Moderate | `Workspace.Destinations.DUNGEON10` |

`HOME` is the hub, not a maze.

Folder id, marketing name, and “Level N” label do **not** line up (site 11 is “Level 1”; site 1 is “Level 3”). See [backlog](backlog.md).
